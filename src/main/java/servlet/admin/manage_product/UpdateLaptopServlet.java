...
import dao.admin.manage_product.UpdateLaptopDAO;
...
@WebServlet("/adminPage/updateLaptop")
...
public class UpdateLaptopServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Laptop newLaptop = new Laptop(name, description, imagePath, price, brand, category, cpu, gpu, ram, drive, size,
				resolution);
		newLaptop.setLaptopId(laptopId);

		UpdateLaptopDAO updateLaptop = new UpdateLaptopDAO();
		boolean isSuccess = updateLaptop.isUpdateLaptop(newLaptop);
