				...
				<div class="card-body" style="margin-top: -13px">
					<a href="${pageContext.request.contextPath}/detailPeripheral?productId=${peripheral.peripheralId}" style="text-decoration: none; color: black">
						...
						<div 
							...
							<span class="text-warning me-1">${peripheral.rate}</span> <i
								class="bi bi-star-fill text-warning me-1"></i> (${peripheral.quantityReview})đánh giá
						</div>
					</a>
					<div class="col d-flex justify-content-between">
						<a href="${pageContext.request.contextPath}/buyNow?productId=${peripheral.peripheralId}" class="btn btn-outline-primary"
